...
// public static int selectedService = -1;
	 ...
	 *            CommandListener
	 */
	public BLUElet(final MIDlet host, final CommandListener listener) {
		BLUElet.host = host;
		callback = listener;
		instance = this;
	}
	...
	/**
	 * Obtain reference to device selection screen component. You should show this screen when user invoke device
	 * search.
	 * 
	 * @return Screen
	 */
	...
	/**
	 * Get all discovered services from selected remote device. Your application call this method after your app receive
	 * COMPLETED callback event. This will return all services that match your UUIDs in startInquiry().
	 * 
	...
	/**
	 * Get the first discovered service from selected remote device. Your application call this method after your app
	 * receives COMPLETED callback event. This will return the first service that match your UUIDs in startInquiry().
	 * 
	 ...
	 * DiscoveryListener.inquiryCompleted(). Your application cal call this method after a COMPLETED callback event is
	 * received.
	 * 
	 * @return int
	 */
	 ...
	 * DiscoveryListener.serviceSearchCompleted(). Your application cal call this method after a COMPLETED callback
	 * event is received.
	 * 
	 * @return int
	 */
	...
	/**
	 * Return user selected remote device that is used for service discovery. Your application can call this after your
	 * app received SELECTED callback event.
	 * 
	...
	public void startInquiry(final int mode, final UUID[] serviceUUIDs) {
		try {
			...
			agent.startInquiry(mode, new Listener());
	...
	public void commandAction(final Command c, final Displayable d) {
		...
		if (label.equals("Search")) {
			...
			final RemoteDevice remoteDevice = (RemoteDevice) devices.elementAt(selectedDevice);
	...
	/**
	 * Bluetooth listener object. Register this listener object to DiscoveryAgent in device inqury and service
	 * discovery.
	 */
